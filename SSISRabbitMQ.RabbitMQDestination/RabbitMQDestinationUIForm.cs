...
{
    public partial class RabbitMQDestinationUIForm : Form
    {
        ...
        public RabbitMQDestinationUIForm()
        {
            InitializeComponent();
        }

        public RabbitMQDestinationUIForm(Microsoft.SqlServer.Dts.Pipeline.Wrapper.IDTSComponentMetaData100 metaData, IServiceProvider serviceProvider)
            : this()
        {
        ...
        private void RabbitMQDestinationUIForm_Load(object sender, EventArgs e)
        {
            var connections = connectionService.GetConnections();

            var exchangeName = metaData.CustomPropertyCollection[0];
            txtExchangeName.Text = exchangeName.Value;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                designTimeInstance.SetComponentProperty("ExchangeName", txtExchangeName.Text);
            }
